...
export declare class BaseModel {
    ...
    save(_noSave?: boolean): Promise<IQuery>;
    _save(db: Db, noSave: boolean): Promise<IQuery>;
    _save$(modelSchema: ISchema, isNew: boolean, updateData: boolean, keypath: string, query: IQuery, db: Db, noSave: boolean): Promise<IQuery>;
